...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #28a745, #00ffec); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp MEDPOINT HOSPITALS</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> We are here to help you out !<br>Advanced Healthcare Solutions</br></h4>
          </div>
